...
from pyinsteon.managers.scene_manager import (
    add_device_to_scene,trigger_scene_off, trigger_scene_on, identify_scenes)
...
async def do_run():
    ...
    device1.states[1].subscribe(state_changed)
    device2 = devices['13.37.42']
    device2.states[1].subscribe(state_changed)
