...
from . import (PLM, ClimateControl_Thermostat, DimmableLightingControl,
...
class IPDB:
    ...
    _products = [
        ...
        Product(0x05, 0x07, None, 'Wireless Thermostat', '2441ZTH', ClimateControl_Thermostat),
        ...
        Product(0x05, 0x0A, None, 'Wireless Thermostat', '2441ZTH', ClimateControl_Thermostat),
        ...
        Product(0x05, 0x11, None, "Wireless Thermostat", "2732-432", ClimateControl_Thermostat),
        Product(0x05, 0x12, None, "Wireless Thermostat", "2732-532", ClimateControl_Thermostat),
