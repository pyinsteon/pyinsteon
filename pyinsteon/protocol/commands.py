...
commands.add(STATUS_REQUEST, 0x19, 0x00, False)
commands.add(STATUS_REQUEST_ALTERNATE_1, 0x19, 0X01, False)
commands.add(STATUS_REQUEST_ALTERNATE_2, 0x19, 0X02, False)
commands.add(STATUS_REQUEST_ALTERNATE_3, 0x19, 0X03, False)
