...
INBOUND_MSG_DEF[MessageId.GET_FIRST_ALL_LINK_RECORD] = MessageDefinition(
    ...
    topics.GET_FIRST_ALL_LINK_RECORD,
...
INBOUND_MSG_DEF[MessageId.SET_NAK_MESSAGE_BYTE] = MessageDefinition(
    ...
    topics.SET_NAK_MESSAGE_BYTE,
    FLD_SET_ACK_NAK_BYTE_ACK,
)
INBOUND_MSG_DEF[MessageId.SET_ACK_MESSAGE_TWO_BYTES] = MessageDefinition(
    MessageId.SET_ACK_MESSAGE_TWO_BYTES,
    topics.SET_ACK_MESSAGE_TWO_BYTES,
    FLD_SET_ACK_TWO_BYTES_ACK,
)
INBOUND_MSG_DEF[MessageId.RF_SLEEP] = MessageDefinition(
    MessageId.RF_SLEEP, topics.RF_SLEEP, FLD_RF_SLEEP_ACK
)
INBOUND_MSG_DEF[MessageId.GET_IM_CONFIGURATION] = MessageDefinition(
    MessageId.GET_IM_CONFIGURATION, topics.GET_IM_CONFIGURATION, FLD_GET_IM_CONFIG_ACK
)
INBOUND_MSG_DEF[MessageId.READ_EEPROM] = MessageDefinition(
    MessageId.READ_EEPROM, topics.READ_EEPROM, FLD_READ_EEPROM_ACK
)
INBOUND_MSG_DEF[MessageId.WRITE_EEPROM] = MessageDefinition(
    MessageId.WRITE_EEPROM, topics.WRITE_EEPROM, FLD_WRITE_EEPROM_ACK
)

OUTBOUND_MSG_DEF = {}
OUTBOUND_MSG_DEF[MessageId.GET_IM_INFO] = MessageDefinition(
    MessageId.GET_IM_INFO, topics.GET_IM_INFO, FLD_GET_IM_INFO_SEND
)
OUTBOUND_MSG_DEF[MessageId.SEND_ALL_LINK_COMMAND] = MessageDefinition(
    MessageId.SEND_ALL_LINK_COMMAND, topics.SEND_ALL_LINK_COMMAND, FLD_SEND_ALL_LINK_CMD
)
OUTBOUND_MSG_DEF[MessageId.SEND_STANDARD] = MessageDefinition(
    MessageId.SEND_STANDARD, topics.SEND_STANDARD, FLD_STD_SEND, False
)
OUTBOUND_MSG_DEF[MessageId.X10_SEND] = MessageDefinition(
    MessageId.X10_SEND, topics.X10_SEND, FLD_X10_SEND_REC, False
)
OUTBOUND_MSG_DEF[MessageId.START_ALL_LINKING] = MessageDefinition(
    MessageId.START_ALL_LINKING, topics.START_ALL_LINKING, FLD_START_ALL_LINKING
)
OUTBOUND_MSG_DEF[MessageId.CANCEL_ALL_LINKING] = MessageDefinition(
    MessageId.CANCEL_ALL_LINKING, topics.CANCEL_ALL_LINKING, FLD_CANCEL_ALL_LINKING
)
...
OUTBOUND_MSG_DEF[MessageId.RESET_IM] = MessageDefinition(
    MessageId.RESET_IM, topics.RESET_IM, FLD_RESET_IM
)
OUTBOUND_MSG_DEF[MessageId.SET_ACK_MESSAGE_BYTE] = MessageDefinition(
    MessageId.SET_ACK_MESSAGE_BYTE, topics.SET_ACK_MESSAGE_BYTE, FLD_SET_ACK_NAK_BYTE
)
...
OUTBOUND_MSG_DEF[MessageId.SET_IM_CONFIGURATION] = MessageDefinition(
    MessageId.SET_IM_CONFIGURATION, topics.SET_IM_CONFIGURATION, FLD_SET_IM_CONFIG
)
...
OUTBOUND_MSG_DEF[MessageId.LED_ON] = MessageDefinition(
    MessageId.LED_ON, topics.LED_ON, FLD_LED_ON_OFF
)
OUTBOUND_MSG_DEF[MessageId.LED_OFF] = MessageDefinition(
    MessageId.LED_OFF, topics.LED_OFF, FLD_LED_ON_OFF
)
...
OUTBOUND_MSG_DEF[MessageId.SET_NAK_MESSAGE_BYTE] = MessageDefinition(
    MessageId.SET_NAK_MESSAGE_BYTE, topics.SET_NAK_MESSAGE_BYTE, FLD_SET_ACK_NAK_BYTE
)
...
OUTBOUND_MSG_DEF[MessageId.RF_SLEEP] = MessageDefinition(
    MessageId.RF_SLEEP, topics.RF_SLEEP, FLD_RF_SLEEP
)
OUTBOUND_MSG_DEF[MessageId.GET_IM_CONFIGURATION] = MessageDefinition(
    MessageId.GET_IM_CONFIGURATION, topics.GET_IM_CONFIGURATION, FLD_GET_IM_CONFIG
)

OUTBOUND_MSG_DEF[MessageId.READ_EEPROM] = MessageDefinition(
    MessageId.READ_EEPROM, topics.READ_EEPROM, FLD_READ_EEPROM
)

OUTBOUND_MSG_DEF[MessageId.WRITE_EEPROM] = MessageDefinition(
    MessageId.WRITE_EEPROM, topics.WRITE_EEPROM, FLD_WRITE_EEPROM
)
