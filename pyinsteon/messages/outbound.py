...
from ..constants import (MessageId, DeviceCategory, AllLinkMode,
...
def send_all_link_command(group: int, mode: AllLinkMode) -> Outbound:
...
def send_standard(address: Address, flags: MessageFlags, cmd1: int, cmd2: int) -> Outbound:
...
def x10_send(raw_x10: int, x10_flag: int) -> Outbound:
...
def start_all_linking(mode: AllLinkMode, group: int) -> Outbound:
...
def cancel_all_linking() -> Outbound:
...
def set_host_dev_cat(cat: DeviceCategory, subcat: int, firmware: int) -> Outbound:
...
def set_ack_message_byte(cmd2: int) -> Outbound:
...
def get_first_all_link_record() -> Outbound:
...
def get_next_all_link_record() -> Outbound:
...
def set_im_configuration(flags: IMConfigurationFlags) -> Outbound:
...
def get_all_link_record_for_sender() -> Outbound:
...
def set_nak_message_byte(cmd2: int) -> Outbound:
...
def set_ack_message_two_bytes(cmd1: int, cmd2: int) -> Outbound:
...
def get_im_configuration() -> Outbound:
