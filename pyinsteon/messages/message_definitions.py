...
FLD_MANAGE_ALL_LINK_RECORD = [MessageField('action', 1, ManageAlLinkRecordAction),
...
INBOUND_MSG_DEF[MessageId.USER_RESET_DETECTED] = MessageDefinition(
                        ...
                        FLD_USER_RESET_REC)
INBOUND_MSG_DEF[MessageId.ALL_LINK_CEANUP_FAILURE_REPORT] = MessageDefinition(
                        MessageId.ALL_LINK_CEANUP_FAILURE_REPORT,
